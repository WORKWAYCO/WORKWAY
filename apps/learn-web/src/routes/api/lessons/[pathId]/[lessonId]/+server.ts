...
async function loadLessonMarkdown(
  ...
  > = {
    "getting-started": {
      "wezterm-setup": () =>
        import("$lib/content/lessons/getting-started/wezterm-setup.md?raw"),
      "claude-code-setup": () =>
        import("$lib/content/lessons/getting-started/claude-code-setup.md?raw"),
      "neomutt-setup": () =>
        import("$lib/content/lessons/getting-started/neomutt-setup.md?raw"),
      "workway-cli": () =>
        import("$lib/content/lessons/getting-started/workway-cli.md?raw"),
      "essential-commands": () =>
    ...
    "workflow-foundations": {
      ...
      triggers: () =>
        import("$lib/content/lessons/workflow-foundations/triggers.md?raw"),
    },
    "building-workflows": {
      "first-workflow": () =>
      ...
      "workers-ai": () =>
        import("$lib/content/lessons/building-workflows/workers-ai.md?raw"),
      "error-handling": () =>
        import("$lib/content/lessons/building-workflows/error-handling.md?raw"),
      "local-testing": () =>
        import("$lib/content/lessons/building-workflows/local-testing.md?raw"),
    },
    "systems-thinking": {
      "compound-workflows": () =>
