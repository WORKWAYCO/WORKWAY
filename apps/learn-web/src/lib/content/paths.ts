...
export const paths: Path[] = [
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        description:
          "Install WezTerm and configure it for optimal developer experience.",
        duration: "15 min",
        praxis:
      ...
      },
      {
        ...
        duration: "20 min",
        praxis:
          "Install Neomutt and configure it for Gmail with an app password. Practice navigation with j/k and search with /.",
      },
      {
        id: "workway-cli",
      ...
      },
      {
        ...
        description:
          "Learn the key commands and shortcuts for efficient workflow development.",
        duration: "15 min",
        praxis:
          "Add WORKWAY development aliases to your shell config (wd, wdp, wl, gs, cc) and practice keyboard shortcuts.",
      },
    ],
  },
  {
    ...
    lessons: [
      {
        ...
        description:
          "Understand the Zuhandenheit philosophy and how workflows create invisible automation.",
        duration: "15 min",
        praxis:
          "Write down three manual tasks and reframe each as an outcome. Apply the Outcome Test: describe value without mentioning technology.",
      },
      {
        id: "define-workflow-pattern",
        title: "The defineWorkflow() Pattern",
        description:
          "Learn the structure of a WORKWAY workflow and its required components.",
        duration: "25 min",
        praxis:
      ...
      },
      {
        ...
        description:
          "Connect external services using the BaseAPIClient pattern.",
        duration: "30 min",
        praxis:
  ...
  },
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        duration: "40 min",
        praxis:
          "Create a workflow that chains Zoom → Notion → Slack when a meeting ends. Test each integration call individually.",
      },
      {
        id: "workers-ai",
  ...
  },
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        description:
          "Master the Cloudflare Workers V8 runtime: Web APIs, package compatibility, and execution limits.",
        duration: "30 min",
        praxis:
      ...
      },
      {
        ...
        description:
          "Create reusable workflow patterns for client deployments.",
        duration: "40 min",
        praxis:
      ...
      },
      {
        ...
        description:
          "Use Cloudflare analytics and logs for production troubleshooting.",
        duration: "25 min",
        praxis:
      ...
      },
      {
        ...
        description:
          "Apply Zuhandenheit and Dieter Rams principles to create workflows that recede.",
        duration: "30 min",
        praxis:
