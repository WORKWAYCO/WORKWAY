...
export async function loadLesson(
  ...
  > = {
    "getting-started": {
      ...
      "claude-code-setup": () =>
        import("./getting-started/claude-code-setup.md?raw"),
      "neomutt-setup": () => import("./getting-started/neomutt-setup.md?raw"),
      "workway-cli": () => import("./getting-started/workway-cli.md?raw"),
      "essential-commands": () =>
        import("./getting-started/essential-commands.md?raw"),
    },
    "workflow-foundations": {
      "what-is-workflow": () =>
        import("./workflow-foundations/what-is-workflow.md?raw"),
      "define-workflow-pattern": () =>
        import("./workflow-foundations/define-workflow-pattern.md?raw"),
      "integrations-oauth": () =>
        import("./workflow-foundations/integrations-oauth.md?raw"),
      "config-schemas": () =>
        import("./workflow-foundations/config-schemas.md?raw"),
      triggers: () => import("./workflow-foundations/triggers.md?raw"),
    },
    "building-workflows": {
      "first-workflow": () =>
        import("./building-workflows/first-workflow.md?raw"),
      "working-with-integrations": () =>
        import("./building-workflows/working-with-integrations.md?raw"),
      "workers-ai": () => import("./building-workflows/workers-ai.md?raw"),
      "error-handling": () =>
        import("./building-workflows/error-handling.md?raw"),
      "common-pitfalls": () =>
        import("./building-workflows/common-pitfalls.md?raw"),
      "local-testing": () =>
        import("./building-workflows/local-testing.md?raw"),
    },
    "systems-thinking": {
      "compound-workflows": () =>
        import("./systems-thinking/compound-workflows.md?raw"),
      "worker-patterns": () =>
        import("./systems-thinking/worker-patterns.md?raw"),
      "private-workflows": () =>
        import("./systems-thinking/private-workflows.md?raw"),
      "agency-patterns": () =>
        import("./systems-thinking/agency-patterns.md?raw"),
      "performance-rate-limiting": () =>
        import("./systems-thinking/performance-rate-limiting.md?raw"),
      "monitoring-debugging": () =>
        import("./systems-thinking/monitoring-debugging.md?raw"),
      "design-philosophy": () =>
        import("./systems-thinking/design-philosophy.md?raw"),
    },
  };
